...
public class StudentListFrame extends JFrame {
	...
	private JTable studentTable2 = null;
	/**
	...
	public StudentListFrame(List<Student> listeStudentsInitiale) {
		...
		JTable table1=  this.getStudentTable();
		table1.setModel(this.studentTM);
		JTable table2=  this.getStudentTable();
		table2.setModel(this.studentTM);
	...
	private JTable getStudentTable() {
		if (this.studentTable == null) {
			...
			this.studentTable2 = this.studentTable;
		}
	...
	private void ajoutStudent() {
		...
		if (popupResult){
			...
			// action non validée
			JOptionPane.showMessageDialog(this,"ok on ne créer rien");
		}
	}
    	...
    	if ( selectedRow >= 0 ) {
    		...
    		if ( stud != null ) {
    			...
    			if ( popupResult) {
    				...
    				studentTM.updateStudentAt(stud, selectedRow);
    				//this.repaint();
	...
	private void supprStudent() {
		int selectedRow = this.getStudentTable().getSelectedRow();
		studentTM.removeStudent(selectedRow);
